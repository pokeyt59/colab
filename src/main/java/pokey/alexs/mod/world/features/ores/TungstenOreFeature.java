...
public class TungstenOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("pokey_and_alexs_mod:tungsten_ore", FEATURE,
				new OreConfiguration(TungstenOreFeatureRuleTest.INSTANCE, PokeyAndAlexsModModBlocks.TUNGSTEN_ORE.get().defaultBlockState(), 7));
		PLACED_FEATURE = PlacementUtils.register("pokey_and_alexs_mod:tungsten_ore", CONFIGURED_FEATURE,
	...
	private static class TungstenOreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("pokey_and_alexs_mod:tungsten_ore_match"), CUSTOM_MATCH);
		}
