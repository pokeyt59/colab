	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("pokey_and_alexs__mc_mod:riceplant", FEATURE,
				FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
						new SimpleBlockConfiguration(BlockStateProvider.simple(PokeyAndAlexsMcModModBlocks.RICEPLANT.get().defaultBlockState())),
						List.of(), 64));
		PLACED_FEATURE = PlacementUtils.register("pokey_and_alexs__mc_mod:riceplant", CONFIGURED_FEATURE,
