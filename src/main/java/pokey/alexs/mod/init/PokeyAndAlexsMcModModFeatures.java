...
public class PokeyAndAlexsMcModModFeatures {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.FEATURES, PokeyAndAlexsMcModMod.MODID);
